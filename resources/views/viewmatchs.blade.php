...
@endphp     
        @if ($team1->squadlist()->where('match_id', $match->id)->first() && $team2->squadlist()->where('match_id', $match->id)->first())
                
        <div class="match">
                            
            <a style="text-decoration: none; color:black;" href="{{ route('matchinfo',[$match]) }}">
