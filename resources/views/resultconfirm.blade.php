...
<body>
    ...
    <div class="form-container">
        <form action="{{ route('resultconfirm',[$result]) }}" method="POST">  
            @csrf    
            <div>
                <label for="valid" class="radio-label">
                  <input type="radio" id="valid" name="valid" value="valid" required>
                  <div class="radio-custom"></div>
                  Valid
                </label>
              </div>
              <div>
                <label for="not_valid" class="radio-label">
                  <input type="radio" id="not_valid" name="valid" value="not valid" required>
                  <div class="radio-custom"></div>
                  Not Valid
                </label>
              </div>        
