        ...
        return $form
            ->schema([
                Select::make('team_id')
                    ...
                    ->label('team')
                    ->required(),
                // Select::make('squadlist_id')
                //     ->relationship('squadlist', 'id')
                //     ->preload()
                //     ->searchable()    
                //     ->label('squadlist'),
                TextInput::make('name')
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('position')->sortable()->searchable()->toggleable(),
                // TextColumn::make('squadlist_id')->label('squadlist')->sortable()->searchable()->toggleable(),
